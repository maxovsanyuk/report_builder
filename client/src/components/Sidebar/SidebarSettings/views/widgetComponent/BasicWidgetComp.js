...
import DefineBasicWidgetSettings from "./views/DefineBasicWidgetSettings";

const BasicWidgetComp = ({ choosenWidget }) => {
  ...
  return (
    <Paper style={{ padding: "10px 10px 20px 10px", margin: "10px 0" }}>
      ...
      <DefineBasicWidgetSettings choosenWidget={choosenWidget} />
...
export default BasicWidgetComp;
