...
const FilterForNewDataSet = ({
  ...
  useEffect(() => {
    ...
    setIsFullEntitie(
      filterState.selectedlogicalOperator
        ? true
        : filterState?.selectedFieldType &&
          get(filterState, "selectedOperator") &&
          filterState.selectedOperator.value &&
    ...
    filterState.selectedValue,
    filterState.checked,
    get(filterState, "selectedOperator") && filterState.selectedOperator.value,
  ]);
  ...
  useEffect(() => {
        ...
        dispatch(
          setNewDataSetState({
            ...
            entities: [
              ...
              {
                id: new Date().getTime(),
                selectedEntity: get(filterState, "selectedFieldType"),
                dataSetTypes: {
    ...
    if (get(filterState, "selectedFieldType.type") === "related") {
      setEntitiState({
        ...entitiState,
  ...
  }, [get(filterState, "selectedFieldType.type") === "related"]);

  if (filterState.selectedlogicalOperator) {
    return (
      <CombinedFilter>
