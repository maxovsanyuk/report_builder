...
const FilterComponent = ({
  ...
  useEffect(() => {
    currentFiltertstate && !currentFiltertstate?.selectedValue
    ...
    >
      ...
      <FormControl>
        ...
        <Select
          ...
          value={
            currentFiltertstate?.selectedFieldType?.label ||
            filterState?.selectedFieldType?.label
          }
          renderValue={() => {
            return (
              <div
      ...
      <FormControl>
        ...
        <Select
          ...
          value={
            currentFiltertstate?.selectedOperator?.label ||
            filterState?.selectedOperator?.label
          }
          renderValue={() => {
            return (
              <div
